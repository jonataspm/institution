...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const rows = [
    ...
    createData('Manuntenção e Suporte Tecnico', 'fechado', 3, 'no actions'),
    createData('Ambulatorio', 'fechado', 6, 'no actions'),
  ];
                ...
                <div className='TableDiv'>
                    <TableContainer component={Paper} >
                        ...
                        <TableHead  >
                            ...
                            <StyledTableCell align="center"><b>Situação</b></StyledTableCell>
                            <StyledTableCell align="center"><b>Submição</b></StyledTableCell>
                            <StyledTableCell align="center"><b>Ações</b></StyledTableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                            {rows.map((row) => (
                            <StyledTableRow key={row.name}>
                                ...
                                <StyledTableCell align="center">{row.submition}</StyledTableCell>
